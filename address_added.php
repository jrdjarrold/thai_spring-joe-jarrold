...
<html>
	<head>
		...
		-->		
		<title>Thai Spring | Address Added</title>
		...
		<div id="dashboard_container">
			...
			<div id="container_dashboard">
				<div id="order_placed_message">
					<p>Your new delivery address has been added to your account</p>
					<p>Click <a href="member_place_order.php">HERE</a> to place an order</p>
