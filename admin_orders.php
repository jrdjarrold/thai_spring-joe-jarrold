...
<html>
	<head>
		...
		-->		
		<title>Thai Spring | Admin | Orders</title>
		...
		<div id="dashboard_container">
			...
			<div id="container_dashboard">
				<div id="newaddy1">
					...
					<p>Displayed below is a list of all orders placed by customers</p>
					<div id="table002">
						<?php
							mysql_select_db('thai_spring',$connection);
							$sql = "SELECT * FROM order_infomation";
							...
							echo "<table id='customerorderstable'>
								...
								while ($record = mysql_fetch_array($myorders)) {
									...
									echo "<td>" . $record['date_of_order'] . "</td>";
